...
//to make this work I went back into the terminal and read what was wrong AGAIN and saw that I might need to do 
//"npm install --save-dev", I did that AFTER making all the correct changes by following along to the solutions code and it WORKED!!!!!!!!
